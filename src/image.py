...
class radmc3dImage(object):
    ...
    def plotMomentMap(self, moment=0, nu0=None, wav0=None, dpc=1., au=False, arcsec=False, cmap=None, vclip=None, Tb=False):
        ...
        Tb     : If True convert the intensity into units of K
        ...
        print("Min/max moment: ", np.min(mmap), np.max(mmap))

        if moment > 0:
            mmap0 = self.getMomentMap(moment=0, nu0=nu0, wav0=wav0, Tb=Tb)
            mmap = mmap / mmap0
    ...
    def getMomentMap(self, moment=0, nu0=None, wav0=None, Tb=None):
